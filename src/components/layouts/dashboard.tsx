...
import { MetaTags, Menus, ButtonTheme } from '@/components';
...
export default function DashboardLayout({ children, ...props }: Props) {
    ...
    return (
        <>
            ...
            <div className={`${styles.content} bg-white dark:bg-[#0F172A] ${className}`} {...propsExtra}>
                ...
                <aside ref={sidebar} className="w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B]">
                    ...
                    <Menus.Dashboard maxSidebar={maxSidebar} miniSidebar={miniSidebar} />
                </aside>
