...
export default function TemplatePage() {
    return (
        <>
            ...
            <script async src="https://demo.themesberg.com/windster/app.bundle.js"></script>

            <nav className="flex items-between justify-center bg-white border-b border-gray-200 fixed z-30 w-full">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden lg:flex items-center">
                                ...
                                <div className="-mb-1">
                                    <Link className="github-button" href="#" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themesberg/windster-tailwind-css-dashboard on GitHub">Star</Link>
                                </div>
                            </div>
                            <Link href="#" className="hidden sm:inline-flex ml-5 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
            ...
            <div className="flex overflow-hidden bg-white pt-16">
                        ...
                        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                            <div className="flex-1 px-3 bg-white divide-y space-y-1">
                                <ul className="space-y-2 pb-2">
                                    ...
                                    <li>
                                        <Link href="#" target="_blank" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                ...
                <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                    ...
                    <p className="text-center text-sm text-gray-500 my-10">
                        &copy; 2019-2021 <Link href="#" className="hover:underline" target="_blank">Themesberg</Link>. All rights reserved.
                    </p>
                </div>
            </div>
        </>
