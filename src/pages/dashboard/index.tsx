...
import { Alert, Nav, Layouts } from "@/components";
...
export default function TemplatePage() {
    ...
    return (
        <Layouts.Dashboard>
            <Nav current="Templates" previous={[
                {
                    label: 'Home',
            ...
            <Alert title="Info alert!" message="Change a few things up and try submitting again." type="info" />
            <Alert title="Danger alert!" message="Change a few things up and try submitting again." type="danger" />
            <Alert title="Success alert!" message="Change a few things up and try submitting again." type="success" />
            <Alert title="Warning alert!" message="Change a few things up and try submitting again." type="warning" />
                    ...
                    <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                        <div className="mb-4 flex items-center justify-between">
                            ...
                            <div className="flex-shrink-0">
                                <Link href="#" className="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg p-2">View all</Link>
                            </div>
                        </div>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm text-gray-500 truncate">
                                            <Link href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="17727a767e7b57607e7973646372653974787a">[email&#160;protected]</Link>
                                        </p>
                                    </div>
                            ...
                            <li className="py-3 sm:py-4">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm text-gray-500 truncate">
                                            <Link href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="d4b1b9b5bdb894a3bdbab0a7a0b1a6fab7bbb9">[email&#160;protected]</Link>
                                        </p>
                                    </div>
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                        $3467
                            ...
                            <li className="py-3 sm:py-4">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm text-gray-500 truncate">
                                            <Link href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="57323a363e3b17203e3933242332257934383a">[email&#160;protected]</Link>
                                        </p>
                                    </div>
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                        $67
                            ...
                            <li className="py-3 sm:py-4">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm text-gray-500 truncate">
                                            <Link href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="284d45494144685f41464c5b5c4d5a064b4745">[email&#160;protected]</Link>
                                        </p>
                                    </div>
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                        $2367
                            ...
                            <li className="pt-3 sm:pt-4 pb-0">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm text-gray-500 truncate">
                                            <Link href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="a2c7cfc3cbcee2d5cbccc6d1d6c7d08cc1cdcf">[email&#160;protected]</Link>
                                        </p>
                                    </div>
                                    <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                        $367
